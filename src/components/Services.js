  ...
  return (
    <section className="section services-section">
      ...
      <div className="services-list">
        {services.map((svc, idx) => (
          <motion.div
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 10px 20px rgba(0,0,0,0.22)" }}
      ...
      <p className="services-guarantee">
        <span className="guarantee-badge">Best Quality Guarantee</span>: Every repair is backed by our commitment to excellence.
      </p>
    </section>
  );
}
